<?php
    ...
    function connectDatabase() {
        ...
        try {
            ...
            // Create PDO instance with persistent connection (prevents Hostinger 20 conn/sec limit)
            ...
            // Fallback retry without persistent connection if host environment blocks it
            try {
                $pdo = new PDO($dsn, $db_user, $db_pass, [
