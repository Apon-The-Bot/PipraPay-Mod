    ...
    class TwentySixTheme
    {
        ...
        public function fields()
        {
            return [
                ...
                [
                    'name'  => 'auto_redirect',
                    'label' => 'Auto Redirect on Payment Success',
                    'type'  => 'select',
                    'options' => [
                        'enabled'  => 'Enable',
                        'disabled' => 'Disable',
                ...
                [
                    ...
                    'value' => '3',
                    'required' => false,
                    'placeholder' => 'e.g. 3 (0 for immediate)',
                ],
            ];
        }
        ...
        public function lang_text()
        {
            return [
                ...
                'redirecting_to_site' => [
                    'en' => 'Redirecting to website in',
                    'bn' => 'ওয়েবসাইটে রিডাইরেক্ট করা হচ্ছে',
                    'hi' => 'वेबसाइट पर पुनर्निर्देशित किया जा रहा है',
                    'ur' => 'ویب سائٹ پر ری ڈائریکٹ کیا جا رہا ہے',
                    'ar' => 'جارٍ إعادة التوجيه إلى الموقع خلال',
                ],
                ...
                'redirect_now' => [
                    'en' => 'Click here if not redirected automatically',
                    'bn' => 'স্বয়ংক্রিয়ভাবে রিডাইরেক্ট না হলে এখানে ক্লিক করুন',
                    'hi' => 'यदि स्वचालित रूप से पुनर्निर्देशित नहीं हुआ तो यहाँ क्लिक करें',
                    'ur' => 'اگر خودکار طور پر ری ڈائریکٹ نہیں ہوتا ہے تو یہاں کلک کریں',
                    'ar' => 'انقر هنا إذا لم تتم إعادة التوجيه تلقائيًا',
                ],
