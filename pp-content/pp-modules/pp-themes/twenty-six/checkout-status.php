...
<body style="<?= $bgStyle ?>" loading="lazy">
    <div class="container container-tight py-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                ?>
                    <div class="alert alert-info d-flex align-items-center justify-content-center gap-2 mb-3 mt-2" id="redirect-box" role="alert">
                        <div class="spinner-border spinner-border-sm text-primary" role="status">
                            <span class="visually-hidden">Loading...</span>
                        </div>
                        <div>
                            <span><?php echo $data['lang']['redirecting_to_site'] ?? 'Redirecting to website in'; ?></span>
                            <strong id="countdown-timer"><?php echo max(0, $redirectDelay); ?></strong>
                            <span><?php echo $data['lang']['seconds'] ?? 'seconds...'; ?></span>
                        </div>
                    </div>
                <?php endif; ?>
    ...
    <script data-cfasync="false">
        ...
        <?php if ($isAutoRedirectActive): ?>
        (function() {
            var returnUrl = <?php echo json_encode($returnUrl); ?>;
            var delay = <?php echo max(0, $redirectDelay); ?>;
